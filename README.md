...
**Container Images**:
- `ghcr.io/kylegalloway/forge/forge-controller:v0.12.2`
- `ghcr.io/kylegalloway/forge/forge-webhook:v0.12.2`
- `ghcr.io/kylegalloway/forge/zarfpackagejob:v0.12.2` (used by ZarfPackageJobs)
