...
```bash
# For Podman:
podman build -t localhost/zarfpackagejob:v0.11.6 images/zarfpackagejob/
podman save localhost/zarfpackagejob:v0.11.6 -o /tmp/zarfpackagejob.tar
kind load image-archive /tmp/zarfpackagejob.tar --name forge-dev
rm /tmp/zarfpackagejob.tar

# For Docker:
docker build -t localhost/zarfpackagejob:v0.11.6 images/zarfpackagejob/
kind load docker-image localhost/zarfpackagejob:v0.11.6 --name forge-dev
```
