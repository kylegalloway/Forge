...
forge/forge     0.1.2           v0.11.17          A Helm chart for deploying Forge - a Kubernetes...
```
...
- UDS Bundle Job: `ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17` (used by UDSBundleJobs)
...
helm install forge forge/forge \
  ...
  --namespace forge-system \
  --create-namespace \
  --set controller.image.tag=v0.11.17 \
  --set webhook.image.tag=v0.11.17 \
  --wait
```
...
docker pull ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17
kind load docker-image ghcr.io/kylegalloway/forge/zarfpackagejob:v0.11.17 --name forge-test
kind load docker-image ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17 --name forge-test

# OR using Podman
podman pull ghcr.io/kylegalloway/forge/zarfpackagejob:v0.11.17
podman pull ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17
podman save ghcr.io/kylegalloway/forge/zarfpackagejob:v0.11.17 -o /tmp/zarfpackagejob.tar
podman save ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17 -o /tmp/udsbundlejob.tar
...
docker build -t ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17 images/udsbundlejob/
kind load docker-image ghcr.io/kylegalloway/forge/zarfpackagejob:v0.11.17 --name forge-test
kind load docker-image ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17 --name forge-test

# OR using Podman
podman build -t ghcr.io/kylegalloway/forge/zarfpackagejob:v0.11.17 images/zarfpackagejob/
podman build -t ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17 images/udsbundlejob/
podman save ghcr.io/kylegalloway/forge/zarfpackagejob:v0.11.17 -o /tmp/zarfpackagejob.tar
podman save ghcr.io/kylegalloway/forge/udsbundlejob:v0.11.17 -o /tmp/udsbundlejob.tar
kind load image-archive /tmp/zarfpackagejob.tar --name forge-test
kind load image-archive /tmp/udsbundlejob.tar --name forge-test
...
```text
ghcr.io/kylegalloway/forge/zarfpackagejob    v0.11.17    e8c96af1c3cbd    45MB
ghcr.io/kylegalloway/forge/udsbundlejob    v0.11.17   a1b2c3d4e5f6g    50MB
```
