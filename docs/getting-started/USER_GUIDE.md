...
- Controller: `ghcr.io/kylegalloway/forge/forge-controller:latest` (or `:v0.8.0` for specific version)
- Webhook: `ghcr.io/kylegalloway/forge/forge-webhook:latest` (or `:v0.8.0` for specific version)
