...
if [ "$PHASE" = "Failed" ] || [ "$PHASE" = "Unknown" ]; then
  ...
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  kubectl logs -n forge-system -l app=forge-controller --tail=50 2>/dev/null || echo "No controller logs available"
fi
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "📊 View Forge Metrics:"
echo ""
echo "Port-forward the controller metrics:"
echo "  kubectl port-forward -n forge-system svc/forge-controller-metrics 8080:8080"
echo ""
echo "Query custom Forge metrics (in another terminal):"
echo "  curl http://localhost:8080/metrics | grep forge_"
echo ""
echo "Example Forge metrics to look for:"
echo "  • forge_zarf_package_jobs_created_total - Total ZarfPackageJobs created"
echo "  • forge_zarf_package_jobs_active - Currently active ZarfPackageJobs"
echo "  • forge_jobs_created_total - Total Kubernetes Jobs created"
echo "  • forge_jobs_completed_total - Total Jobs completed successfully"
echo "  • forge_builds_started_total - Build actions started"
echo "  • forge_builds_completed_total - Build actions completed"
echo "  • forge_deploys_started_total - Deploy actions started"
echo "  • forge_deploys_completed_total - Deploy actions completed"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo "  kubectl logs -n forge-system -l app=forge-controller -f"
echo ""
